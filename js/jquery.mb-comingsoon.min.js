(function (n) {
    ...
    t.prototype = {
        getCounterNumbers: function () {
            var n = { days: { tens: 0, units: 4, hundreds: 0 }, hours: { tens: 1, units: 1 }, minutes: { tens: 2, units: 0 }, seconds: { tens: 0, units: 0 } },
                s = 864e5,
                h = 36e5,
                c = 6e4,
                t = 0,
        ...
        localize: function (t) {
            ...
            n(".days", this.$el).siblings(".counter-caption").text();
            n(".hours", this.$el).siblings(".counter-caption").text();
            n(".minutes", this.$el).siblings(".counter-caption").text();
            n(".seconds", this.$el).siblings(".counter-caption").text();
        },
        start: function (n) {
            var i, t;
            n && (this.interval = n);
    ...
    jQuery.fn.mbComingsoon = function (i) {
        var u = { interval: 1e3, callBack: null, localization: { days: "days", hours: "hours", minutes: "minutes", seconds: "seconds" }, speed: 500 },
            r = {},
            f =
                '   <div class="counter-group" id="myCounter">       <div class="counter-block">           <div class="counter days">               <div class="number show n1 hundreds">0</div>               <div class="number show n1 tens">0</div>               <div class="number show n1 units">0</div>               <div class="number hidden-up n2 hundreds">0</div>               <div class="number hidden-up n2 tens">0</div>               <div class="number hidden-up n2 units">0</div>           </div>           <div class="counter-caption"></div>       </div>       <div class="counter-block">           <div class="counter hours">               <div class="number show n1 tens">0</div>               <div class="number show n1 units">0</div>               <div class="number hidden-up n2 tens">0</div>               <div class="number hidden-up n2 units">0</div>           </div>           <div class="counter-caption"></div>       </div>       <div class="counter-block">           <div class="counter minutes">               <div class="number show n1 tens">0</div>               <div class="number show n1 units">0</div>               <div class="number hidden-up n2 tens">0</div>               <div class="number hidden-up n2 units">0</div>           </div>           <div class="counter-caption"></div>       </div>       <div class="counter-block">           <div class="counter seconds">               <div class="number show n1 tens">0</div>               <div class="number show n1 units">0</div>               <div class="number hidden-up n2 tens">0</div>               <div class="number hidden-up n2 units">0</div>           </div>           <div class="counter-caption"></div>       </div>   </div>';
